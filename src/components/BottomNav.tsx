...
function NavIcon({ name, active }: { name: string; active: boolean }) {
  ...
  switch (name) {
    ...
    case "movies":
      return (
        <svg className={cls} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={strokeWidth}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125m-8.625 0V5.625m17.25 12.75c.621 0 1.125-.504 1.125-1.125m-1.125 1.125h-7.5m8.625-1.125V5.625m0 12.75v-1.5m-17.25 1.5v-1.5m0 0V5.625m0 10.625c0 .621.504 1.125 1.125 1.125M2.25 5.625c0-.621.504-1.125 1.125-1.125m0 0h17.25m-17.25 0h7.5m10.875 0c.621 0 1.125.504 1.125 1.125m-1.125-1.125h-7.5m0 0v12.75" />
        </svg>
      );
    case "explore":
      return (
